...
namespace Catfood.Shapefile
{
    ...
    public class Shape
    {
        ...
        //protected internal Shape(ShapeType shapeType, int recordNumber, Dictionary metadata, IDataRecord dataRecord)
        //{
        //    _type = shapeType;
        //    _metadata = metadata;
        ...
        /// <param name="recordNumber">The record number in the Shapefile</param>
        /// <param name="metadata">Metadata about the shape (optional)</param>
        protected internal Shape(ShapeType shapeType, int recordNumber, Dictionary<string, string> metadata)
        {
            _type = shapeType;
            _metadata = metadata;
            _recordNumber = recordNumber;
